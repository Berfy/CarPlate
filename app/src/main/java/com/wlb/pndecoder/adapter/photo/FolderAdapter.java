package com.wlb.pndecoder.adapter.photo;
...
//                    .centerCrop()
//                    .into(cover);
            ViewUtils.setViewHeight(mImageSize, cover);
            ViewUtils.setViewWidth(mImageSize, cover);
            ImageLoader.getInstance().displayImage("file://" + data.cover.path, cover, ImageUtil.getImageLoaderOptions(R.mipmap.default_error, R.mipmap.default_error));
            // TODO 选择标识
        }
    }
