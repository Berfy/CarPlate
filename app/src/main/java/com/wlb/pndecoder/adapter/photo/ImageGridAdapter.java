...
public class ImageGridAdapter extends BaseAdapter {
    ...
    class ViewHolde {
        ...
        void bindData(final Image data) {
            ...
            if (mItemSize > 0) {
                // 显示图片
                ViewUtils.setViewHeight(mItemSize, image);
                ViewUtils.setViewWidth(mItemSize, image);
                ImageLoader.getInstance().displayImage("file://" + data.path, image, ImageUtil.getImageLoaderOptions(R.mipmap.default_error, R.mipmap.default_error));
            }
        }
    }
