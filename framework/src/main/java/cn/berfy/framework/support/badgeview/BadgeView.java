package cn.berfy.framework.support.badgeview;
...
public class BadgeView extends TextView {
    ...
    private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#fd2f3f"); //Color.RED;
    ...
    private void applyLayoutParams() {
        ...
        switch (badgePosition) {
            ...
            case POSITION_RIGHT_CENTER:
                ...
                lp.setMargins(0, badgeMarginV / 2, badgeMarginH, 0);
                break;
            default:
                break;
        }
